...
public class ProviderHandler {
	public static List<Wallpaper> getWallpapers(final List<Provider> providers, final int count, final Resolution resolution) throws ConnectivityException {
		...
		while (remaining > 0) {
			try {
				...
				List<Wallpaper> results = provider.query(random, resolution);
